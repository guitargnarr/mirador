...
**Python Version:** 3.14.0 (recommended)
- **Location:** `/Library/Frameworks/Python.framework/Versions/3.14/bin/python3`
- **Status:** ✅ Fully operational

**Note:** This project primarily uses shell scripts and Ollama. Python is only needed for:
- Testing scripts (`tests/test_*.py`)
- Constraint validation (`constraint_validator.py`)
- Context management (`context_manager.py`)
- Memory system (`ai_memory/init_db.py`)

### Virtual Environment (If needed for Python scripts)
...
pip install -r requirements.txt  # orjson==3.9.15 (3.10+ has compatibility issues)
```
