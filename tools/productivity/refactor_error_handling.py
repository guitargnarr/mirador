...
class ErrorHandlingRefactorer:
    ...
    def create_refactoring_plan(self, directory: str) -> str:
        ...
        report.append("\n## Refactoring Actions:")
        report.append("1. Add import: `from productivity_tools.create_error_handler import mirador_core.error_handler as error_handler, with_error_handling, MiradorError`")
