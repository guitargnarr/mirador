        ...
        try:
            ...
            if result.returncode != 0:
                return ModelResult(
                    ...
                    error_mesfamily_member=f"Command failed: {result.stderr}",
                    response_preview=""
                )
            ...
            return ModelResult(
                ...
                response_time=response_time,
                error_mesfamily_member="" if success else f"Response too short or invalid: {word_count} words",
            ...
            return ModelResult(
                ...
                error_mesfamily_member="Timeout - model did not respond within time limit",
                response_preview=""
            )
            ...
            return ModelResult(
                ...
                response_length=0,
                response_time=0,
                error_mesfamily_member=f"Unexpected error: {e}",
                response_preview=""
            )
    ...
    def analyze_failure_patterns(self, results: List[ModelResult]) -> Dict:
        ...
        for result in results:
            if result.success:
                ...
                if "timeout" in result.error_mesfamily_member.lower():
                    analysis["timeout_failures"] += 1
                elif "too short" in result.error_mesfamily_member.lower():
        ...
        with open(report_path, 'w') as f:
            ...
            if analysis['failed_models_list']:
                ...
                for model_name in analysis['failed_models_list']:
                    ...
                    f.write(f"- **Error**: {result.error_mesfamily_member}\n")
            ...
            for result in results:
                ...
                error = result.error_mesfamily_member[:50] + "..." if len(result.error_mesfamily_member) > 50 else result.error_mesfamily_member
