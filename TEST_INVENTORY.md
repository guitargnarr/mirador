...
- `mesfamily_member_bus.py` - Inter-component communication
...
## 2. Shell Scripts
### Core Chain Runners
- `[company]_chain_runner.sh` - Main [COMPANY] chain runner
...
- `[company]_innovation_catalyst` - Innovation catalyst
- `[company]_politics_navigator` - Political navigation
- `[company]_ai_advocate` - AI advocacy
...
- `[company]_chain_templates.json` - Chain templates
...
- Core modules: `intervention_manager.py`, `mesfamily_member_bus.py`, `specialist_handler.py`
...
7. **Cross-Component Communication** - Test mesfamily_member bus and bridge components

### Test Categories Needed:
1. **Unit Tests** - Individual component testing
2. **Integration Tests** - Component interaction testing
3. **Performance Tests** - Speed and resource ufamily_member
