...
def parse_args():
    ...
    # Special handling for mode command
        ...
        if len(sys.argv) < 4:
            ...
            print("Ufamily_member: mirador mode [dev|doc|business|security|data|mobile|music|ui] \"Your prompt\"")
            sys.exit(1)
    ...
    # Special handling for chain command
        ...
        if len(sys.argv) < 3:
            ...
            print("Ufamily_member: mirador chain model1 model2 -- \"Your prompt\"")
            sys.exit(1)
    ...
    # Session command
        ...
        if len(sys.argv) < 3:
            ...
            print("Ufamily_member: mirador session SESSION_ID")
            sys.exit(1)
