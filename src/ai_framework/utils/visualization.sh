...
# Ufamily_member: show_progress_bar <current> <total> [prefix] [suffix]
show_progress_bar() {
  local current=$1
  local total=$2
...
# Ufamily_member: show_transition <from_model> <to_model>
show_transition() {
  local from_model=$1
  local to_model=$2
...
# Ufamily_member: show_specialist_start <model_name> <step_number> <total_steps>
...
# Ufamily_member: show_specialist_thinking <model_name>
...
# Ufamily_member: show_diff <previous_output> <current_output> [model_name]
show_diff() {
  local prev_file=$1
  local curr_file=$2
...
# Ufamily_member: get_elapsed_time
get_elapsed_time() {
...
# Ufamily_member: format_time <seconds>
format_time() {
  local seconds=$1
...
# Ufamily_member: show_step_completion <model_name>
