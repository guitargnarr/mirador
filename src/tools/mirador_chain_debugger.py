    ...
    def test_individual_model_with_input(self, model_name: str, input_text: str, timeout: int = 45) -> ChainStep:
        ...
        try:
            ...
            return ChainStep(
                ...
                execution_time=execution_time,
                success=success,
                error_mesfamily_member="" if success else "Empty or invalid response"
            )
            ...
            return ChainStep(
                ...
                success=False,
                error_mesfamily_member="Timeout"
            )
            ...
            return ChainStep(
                ...
                execution_time=0,
                success=False,
                error_mesfamily_member=f"Error: {e}"
            )
    ...
    def analyze_chain_issues(self, chain_name: str, steps: List[ChainStep]) -> Dict:
        ...
        for i, step in enumerate(steps):
            if step.success:
                ...
                if "timeout" in step.error_mesfamily_member.lower():
                    analysis["timeout_models"].append(step.model_name)
                elif "empty" in step.error_mesfamily_member.lower():
        ...
        with open(report_path, 'w') as f:
            ...
            for result in results:
                ...
                for i, step in enumerate(steps, 1):
                    ...
                    error = step.error_mesfamily_member[:30] + "..." if len(step.error_mesfamily_member) > 30 else step.error_mesfamily_member
