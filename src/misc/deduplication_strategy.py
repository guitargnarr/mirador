...
def create_deduplication_report():
    ...
    report.append("backup_dir='/Users/matthewscott/ai_framework_git_backup_$(date +%Y%m%d_%H%M%S)'")
    report.append("echo 'Creating backup at: $backup_dir'")
    report.append("cp -r /Users/matthewscott/ai_framework_git \"$backup_dir\"")
    report.append("")
    report.append("# Remove duplicate files")
    report.append("cd /Users/matthewscott/ai_framework_git")
    report.append("```\n")
...
def generate_deletion_script():
    ...
    script.append("if [ ! -d '/Users/matthewscott/ai_framework_git' ]; then")
    script.append("    echo 'Error: ai_framework_git directory not found'")
    script.append("    exit 1")
    script.append("fi")
    script.append("")
    script.append("# Create backup")
    script.append("backup_dir=\"/Users/matthewscott/ai_framework_git_backup_$(date +%Y%m%d_%H%M%S)\"")
    script.append("echo \"Creating backup at: $backup_dir\"")
    script.append("cp -r /Users/matthewscott/ai_framework_git \"$backup_dir\"")
    script.append("")
    script.append("# Delete duplicate files")
    script.append("cd /Users/matthewscott/ai_framework_git")
