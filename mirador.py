...
CHAIN_TEMPLATES = {
    ...
    "innovation": ["matthew_context_provider_v3", "[company]_innovation_catalyst", "solution_architect", "enhanced_agent_enforcer"],
    "ai_leadership": ["matthew_context_provider_v3", "ai_leadership_strategist", "enhanced_agent_enforcer"],
    "corporate_nav": ["matthew_context_provider_v3", "[company]_politics_navigator", "enhanced_agent_enforcer"],
    "solution": ["[company]_innovation_catalyst", "solution_architect", "enhanced_agent_enforcer"],
    "advocates": ["matthew_context_provider_v3", "advocates_meeting_optimizer_v2", "ai_leadership_strategist", "enhanced_agent_enforcer"],
    "quick_win": ["[company]_innovation_catalyst", "solution_architect"],
    "strategic": ["matthew_context_provider_v3", "[company]_innovation_catalyst", "ai_leadership_strategist", "[company]_politics_navigator", "enhanced_agent_enforcer"]
}
