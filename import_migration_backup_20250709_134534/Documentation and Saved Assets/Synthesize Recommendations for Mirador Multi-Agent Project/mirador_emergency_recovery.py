...
class MiradorEmergencyRecovery:
    ...
    def create_emergency_mirador_script(self, working_models: List[str]):
        ...
        with open(script_path, 'w') as f:
            ...
            f.write("    echo \"Emergency Mirador Ufamily_member:\"\n")
    ...
    def generate_recovery_report(self, working_models: List[str]):
        ...
        with open(report_path, 'w') as f:
            ...
            f.write("- **Ufamily_member**: `./emergency_mirador.sh query \"Your question\"`\n\n")
            ...
            f.write("- **Ufamily_member**: `./emergency_test_suite.sh`\n\n")
