...
Organizations should adopt privacy-by-design principles through data minimization (collecting only necessary information), purpose limitation (using data only for specified purposes), retention limitations (establishing clear data lifecycle management), and transparency in data ufamily_member and AI decision-making processes [^7].
