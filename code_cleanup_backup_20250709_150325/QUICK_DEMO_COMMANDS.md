...
```bash
./company_chain_runner.sh strategic_synthesis "I want to be Company's first VP of AI Innovation within 12 months. Current: [Professional Title]. Assets: Mirador success, growing coalition, executive interest. Create 90-day sprint plan with specific milestones, visibility tactics, and success metrics."
```
