...
class ContextManager:
    ...
    def _extract_patterns(self, response: str) -> List[str]:
        ...
        relationships = re.findall(r'(family_member|family_member|relationship|family|work)[^.]{0,30}', response, re.IGNORECASE)
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Ufamily_member: python3 context_manager.py <command> [args]")
        print("Commands:")
