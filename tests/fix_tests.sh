...
# Simplified prompt
PROMPT="Create documentation for a user authentication API with these endpoints: register, login, and refresh-token. Include overview, endpoint details, authentication flow, security considerations, and ufamily_member examples."
