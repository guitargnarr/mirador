...
class ChainTester:
    ...
    def run_all_chain_tests(self):
        ...
        test_cases = [
            ...
            ('[company]_chain_runner.sh', 'corporate_nav', 'How do I navigate a difficult meeting?'),
            ('[company]_chain_runner.sh', 'innovation_discovery', 'Find automation opportunities'),
            ('[company]_chain_runner.sh', 'ai_leadership', 'Position myself as AI leader'),
            ('[company]_chain_runner.sh', 'solution_design', 'Design solution for manual process'),
